...
comparative other iAssets in addition to the iAsset market cap:
...
\item
  ...
  for a particular day within the epoch
\item
  \(x\) is the iAsset LP staker's amount of LP tokens (of a given DEX) staked on Indigo 
\item
  \(a\) is the set of LP tokens' staked amount on Indigo, for a particular iAsset
\end{itemize}
